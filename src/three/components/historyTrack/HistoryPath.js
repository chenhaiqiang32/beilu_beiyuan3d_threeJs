...
export class HistoryPath extends THREE.Mesh {
    /**
     * @param {
    ...
    constructor(points, options = {}) {
        ...
        const _param = { time: this.elapsedTime, seg: seg, position: position };
    ...
    #generateMaterial(option) {
        const material = new THREE.ShaderMaterial({
            uniforms: {
                ...
                edgeColor: { value: new THREE.Color("#0E5744") },
                uColor: { value: new THREE.Color("#28F0BD") },
            },
